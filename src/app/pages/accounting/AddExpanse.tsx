...
import { useGetExpenseHeadsQuery, useGetAccountingAccountsQuery, useAddExpenseHeadwiseMutation } from "@/store/features/app/accounting/accoutntingApiService";
                            ...
                            <CommandGroup>
                              {debitHeads?.map((acc) => {
                                ...
                                return (
                                  <CommandItem
                                    key={acc._id}
                                    value={`${acc.name}-${acc._id}`} // unique, string
                                    onSelect={() => {
                                      field.onChange(acc._id); // convert back to number
