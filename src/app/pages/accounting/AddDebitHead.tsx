...
import { useAddDebitHeadMutation } from "@/store/features/app/accounting/accoutntingApiService";
...
export default function AddDebitHeadForm() {
  ...
  const canCreateDebitHeads = isAdmin || hasPermission(perm(MODULES.ACCOUNTING, ACTIONS.CREATE));
