...
export default function PrintablePurchasePayment({ payment, to }: Props) {
    ...
    const from = payment?.purchaseOrder?.supplier;
                ...
                <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="text-right flex flex-col items-end">
                        ...
                        <div className="details-text space-y-1">
                            ...
                            <p><strong>Receipt No.:</strong> PPAY-{payment?._id.toString().padStart(6, "0")}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full mb-6 text-sm">
                    <table className="w-full border-collapse table-border">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div className="font-bold">Payment for Purchase Order #{payment?.purchaseOrder?.poNumber}</div>
                                    {payment?.invoice && (
